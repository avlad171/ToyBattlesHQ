# Support for this client version is discontinued!
The emulator for version 0.8 is very, very old. 
- There's a lot of unfixed bugs.
- There's a lot of missing support.
- The code is super old and not refactored, and basically unmaintanable.
- No cross platform support.

Refer to mv_1.1_2.0 for the emulator version that targets Microvolts Surge. That's the most updated one!
